...
##' Evaluating Hierarchical Clustering, using Clustering Sum-of-Squares (\emph{\code{css}}).
##'
##' Evaluating Hierarchical Clustering, using Clustering Sum-of-Squares (\emph{\code{css}}).
##' @name css.hclust
##' @aliases css.hclust 
##' @title Computing Sum-of-Squares given Hierarchical Clustering
##' 
##' @param dist.obj a `dist' object, generated by either \emph{\code{dist}} or \emph{\code{gdist}}.
##' @param hclust.obj a `hclust' object, generated by \emph{\code{hclust}}
##' @param hclust.FUN a function, to generate a hierarchical clustering.
##' Ignored with \code{hclust.obj} specified.
##' DEFAULT: \emph{\code{hclust}}
